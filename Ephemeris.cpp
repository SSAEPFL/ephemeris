...
#define SIND(value)   sin((value)*0.0174532925199432957692369076848861271344287188854172545609)
#define COSD(value)   cos((value)*0.0174532925199432957692369076848861271344287188854172545609)
#define TAND(value)   tan((value)*0.0174532925199432957692369076848861271344287188854172545609)

#define ACOSD(value)  (acos((value))*57.295779513082320876798154814105170332405472466564321549160243861);
#define ATAND(value)  (atan((value))*57.295779513082320876798154814105170332405472466564321549160243861);

// Limit range
#define LIMIT_DEGREES_TO_360(value) (value) >= 0 ? ((value)-(long)((value)*0.0027777777777777777777777777777777777777777777777777777777777777)*360) : (((value)-(long)((value)*0.0027777777777777777777777777777777777777777777777777777777777777)*360)+360)
#define LIMIT_HOURS_TO_24(value) (value) >= 0 ? ((value)-(long)((value)*0.0416666666666666666666666666666666666666666666666666666666666666)*24) : ((value)+24)
#define LIMIT_DEC_TO_90(value) (value)

// Convert degrees
#define DEGREES_TO_RADIANS(value) ((value)*0.0174532925199432957692369076848861271344287188854172545609719144)
#define DEGREES_TO_HOURS(value) ((value)*0.0666666666666666666666666666666666666666666666666666666666666666)
#define DEGREES_MINUTES_SECONDES_TO_SECONDS(deg,min,sec) ((float)(deg)*3600+(float)(min)*60+(float)sec)
#define DEGREES_MINUTES_SECONDS_TO_DECIMAL_DEGREES(deg,min,sec) (deg) >= 0 ? ((float)(deg)+(float)(min)*0.0166666666666666666666666666666666666666666666666666666666666666+(float)(sec)*0.0002777777777777777777777777777777777777777777777777777777777777) : ((float)(deg)-(float)(min)*0.0166666666666666666666666666666666666666666666666666666666666666-(float)(sec)*0.0002777777777777777777777777777777777777777777777777777777777777)

// Convert radians
#define RADIANS_TO_DEGREES(value) ((value)*57.295779513082320876798154814105170332405472466564321549160243861)
#define RADIANS_TO_HOURS(value) ((value)*3.8197186342054880584532103209403446888270314977709547699440162574)

// Convert hours
#define HOURS_TO_RADIANS(value) ((value)*0.2617993877991494365385536152732919070164307832812588184145787160)
#define HOURS_MINUTES_SECONDS_TO_SECONDS(hour,min,sec) ((float)(hour)*3600+(float)(min)*60+(float)sec)
#define HOURS_MINUTES_SECONDS_TO_DECIMAL_HOURS(hour,min,sec) ((float)(hour)+(float)(min)*0.0166666666666666666666666666666666666666666666666666666666666666+(float)(sec)*0.0027777777777777777777777777777777777777777777777777777777777777)
#define HOURS_TO_DEGREES(value) ((value)*15)

// Convert seconds
#define SECONDS_TO_DECIMAL_DEGREES(value) ((float)(value)*0.0002777777777777777777777777777777777777777777777777777777777777)
#define SECONDS_TO_DECIMAL_HOURS(value) ((float)(value)*0.0002777777777777777777777777777777777777777777777777777777777777)
